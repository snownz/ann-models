...
class MemoryCell(tf.nn.rnn_cell.RNNCell):
    ...
    def __init__(self, num_units, name, memory, state_is_tuple=False):
        ...
        self.nm = NaluCell( self._num_units, "nm_{}".format( name ), act = tf.nn.tanh )        
    ...
    def call(self, inputs, state):
        ...
        return ( out, mem_update ),\
               ( ( new_m , new_h, _c ) if self._state_is_tuple else array_ops.concat( [ new_m, new_h, _c ], 1 ) )